...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br /><br />
    <asp:Button runat="server" ID="ctrlRegister" OnClick="ctrlRegister_Click" Text="Register" style="margin-right:20px" UseSubmitBehavior="false" />
    <asp:Button runat="server" ID="ctrlLogin" OnClick="ctrlLogin_Click" Text="Log in"  style="float:right; margin-right:400px" UseSubmitBehavior="false" />
</asp:Content>